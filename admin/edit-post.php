...
// Define processBase64Images function
if (!function_exists('processBase64Images')) {
    function processBase64Images($content) {
        // Match all base64 images in the content
        ...
        foreach ($matches as $match) {
            ...
            // Generate unique filename
            $unique_id = uniqid() . '_' . time();
            $filename = $unique_id . '.' . $image_type;
            $filepath = $target_dir . $filename;
            
            // Save the image
            if (file_put_contents($filepath, $image_data)) {
                // Replace base64 src with file path
                $new_src = '../uploads/images/' . $filename;
                $content = str_replace($match[0], str_replace($match[2], '', $match[0]), $content);
                $content = str_replace('data:image/' . $image_type . ';base64,' . $base64_data, $new_src, $content);
            }
        }
...
$title = $post['title'];
$slug = $post['slug'];
// CRITICAL: Decompress the content before displaying in editor
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if (empty($title)) {
        ...
        $slug_check_sql = "SELECT id FROM posts WHERE slug = ? AND id != ?";
        ...
        if ($slug_result->num_rows > 0) {
            ...
            if (isset($_FILES['featured_image']) && $_FILES['featured_image']['error'] === UPLOAD_ERR_OK) {
                ...
                if ($upload_result['success']) {
                    ...
                    if (!empty($featured_image) && file_exists('../uploads/images/' . $featured_image)) {
                        unlink('../uploads/images/' . $featured_image);
                    }
            ...
            // Process content to handle any base64 images (from paste or drag/drop)
            ...
            if ($is_featured == 1) {
                ...
                $conn->query("UPDATE posts SET is_featured = 0 WHERE is_featured = 1 AND id != $post_id");
            }
            ...
            if ($stmt->execute()) {
                ...
                // Reload post data to update display
                $stmt = $conn->prepare("SELECT * FROM posts WHERE id = ?");
                $stmt->bind_param("i", $post_id);
                $stmt->execute();
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&family=Open+Sans:wght@300;400;600;700&family=Lato:wght@300;400;700&family=Montserrat:wght@300;400;500;600;700&family=Poppins:wght@300;400;500;600;700&family=Merriweather:wght@300;400;700&family=Playfair+Display:wght@400;500;600;700&family=Source+Code+Pro:wght@300;400;600&display=swap" rel="stylesheet">
...
<body>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="slug-preview">
                                    ...
                                    Preview: <?php echo SITE_URL; ?>/blog-post.php?slug=<span id="slugPreview"><?php echo htmlspecialchars($slug); ?></span>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="featured-warning">
                                    ...
                                    This post is currently featured on the homepage.
                                </div>
                                <?php else: ?>
    ...
    <script>
        ...
        if (featuredYes && featuredNo && featuredWarning) {
