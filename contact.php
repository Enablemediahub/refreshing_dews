        ...
        try {
            ...
            if ($stmt->execute()) {
                ...
                if (getSetting('contact_send_admin_notification', '1') == '1') {
                    ...
                    $admin_headers .= 'From: ' . getSetting('site_title', 'Refreshing Dews') . ' <' . getSetting('contact_email_display', 'noreply@' . $_SERVER['HTTP_HOST']) . ">\r\n";
...
$contact_email_display = getSetting('contact_email_display', 'contact@refreshingdews.com');
